	...
	<script type="text/javascript">
		$(document).ready(function () {	
			...
			$('#DataViewTable').jtable({
				...
				actions: {
					listAction: 'defaulter_fetch.php?action=list&jtStartIndex=0&jtPageSize=10&jtSorting=null'
				...
				fields: {
						...
						amount_repaid: {
							...
							edit: false,
							display:function(data){
								return '<span><b>'+formatNumber(data.record.amount_repaid)+'</b></span>';
							}
						},
						roll_count: {
							title: 'ROLL COUNT',
						...
						date_repaid: {
							...
							inputClass: 'validate[required]',
							display: function(data){
								return data.record.date_repaid.replace("'","").replace("'","");
							}
						},						
						date_created: {
							title: 'DATE CREATED',
