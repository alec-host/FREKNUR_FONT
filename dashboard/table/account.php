			...
			$('#DataViewTable').jtable({
				...
				toolbar:{
					items: [{
						...
						text: 'Download',
						click: function (){
							window.location = 'report.php?formName=account&action=export-excel&page=<?php echo($nav_page);?>';
							e.preventDefault();
						}
					}]
				},
				...
				actions: {
					listAction: 'account_fetch.php?action=list&jtStartIndex=0&jtPageSize=10&jtSorting=null&page=<?php echo($nav_page);?>'
				},
				fields: {
						id: {
							key: true,
						...
						cr: {
							...
							display:function(data){
								return '<span><b>'+formatNumber(data.record.cr)+'</b></span>';
							}
						},
						dr: {
							title: 'DEBIT',
							...
							edit: false,
							display:function(data){
								return '<span><b>'+formatNumber(data.record.dr)+'</b></span>';
							}
						},											
						balance: {
							title: 'RUNNING BAL',
							...
							edit: false,
							display:function(data){
								return '<span><b>'+formatNumber(data.record.balance)+'</b></span>';
							}
						},
						narration: {
							title: 'PARTICULARS',
