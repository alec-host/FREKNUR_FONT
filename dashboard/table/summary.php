	...
	<script type="text/javascript">
		$(document).ready(function () {	
			...
			$('#DataViewTable').jtable({
				...
				actions: {
					listAction: 'summary_fetch.php?action=list&jtStartIndex=0&jtPageSize=10&jtSorting=null'
				},
				fields: {
						id: {
							key: true,
  ...
  <body>
	<div class="card">
		<div class="container">
			<div class="filtering" >
				<!--form>
				<span>&nbsp;</span><input type="text" name="word" id="word" style="" placeholder=" Type here to search..."/>
